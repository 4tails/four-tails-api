...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FourTails.Core.DomainModels.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("OutgoingMessage")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
            ...
            modelBuilder.Entity("FourTails.Core.DomainModels.Pet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FourTails.Core.DomainModels.Message", b =>
                {
                    b.HasOne("FourTails.Core.DomainModels.User", "MessageAuthor")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("FourTails.Core.DomainModels.Pet", b =>
                {
                    b.HasOne("FourTails.Core.DomainModels.User", "PetOwner")
                        .WithMany("Pets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FourTails.Core.DomainModels.User", null)
                        .WithMany()
